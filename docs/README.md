...
| [devplan.md](devplan.md) | 开发规划：选题决策、架构设计、任务拆分、进度跟踪 | ⭐ 核心 |
| [model-selection.md](model-selection.md) | 可用模型清单（Agnes AI / NVIDIA NIM），含端点与认证方式 | ⭐ 核心 |
| [volcengine-docs-assessment.md](volcengine-docs-assessment.md) | 火山引擎语音文档站摸底评估与抓取计划 | 参考 |

## 二、选题调研

| 文件 | 说明 | 优先级 |
|------|------|--------|
| [research-topic1.md](research-topic1.md) | 题目一（AI视觉对话助手）：开源项目、技术方案、架构分析 | ⭐ 核心 |
| [research-topic2.md](research-topic2.md) | 题目二（AI语音绘图工具）：开源项目、技术方案、架构分析 | ⭐ 核心 |
